...
menuItens.forEach((item, index) => {
  item.addEventListener("click", () => {
    ...
    //    change the choosen product(troca do produto escolhido)
    choosenProduct = products[index];

    // change texts of currentProdcut(alterar textos do currentProduct)
    currentProductTitle.textContent = choosenProduct.title;
    currentProductPrice.textContent = "R$" + choosenProduct.price;
    currentProductImg.src = choosenProduct.colors[0].img;

    //    assing new colors(adicionando novas cores)
